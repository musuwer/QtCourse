...
#include <QMessageBox>
#include <QToolButton>   // 如果你选用QToolButton方式
...
//创建工具栏上无法可视化设计的一些组件
    ...
    // “About” 动作
    QAction* actAbout = new QAction(QIcon(), tr("About"), this);
    actAbout->setToolTip(tr("关于本程序"));
    ui->mainToolBar->addAction(actAbout);

    // 连接信号到槽
    connect(actAbout, &QAction::triggered, this, &MainWindow::on_homework_triggered);
...
#include <QMessageBox>
void MainWindow::on_homework_triggered()   // 或 on_actHelp_About_triggered()
{
    QMessageBox::about(this, tr("About"),
                       tr("<b>姓名：</b>柴承源<br>"
                          "<b>学号：</b>2023414290102<br>"
                          "<b>班级：</b>2023级杨振宁创新班<br>"
                          "<b>日期：</b>2025年9月21日<br>"
                          ));
}
