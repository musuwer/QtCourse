...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/images/200.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/images/202.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/images/204.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/images/500.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/images/502.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/images/504.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actFont_UnderLine->setIcon(icon5);
        actClose = new QAction(MainWindow);
        actClose->setObjectName("actClose");
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/images/132.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        actSys_ToggleText->setChecked(false);
        actEdit_Clear = new QAction(MainWindow);
        actEdit_Clear->setObjectName("actEdit_Clear");
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icons/images/212.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icons/images/206.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icons/images/208.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icons/images/100.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actFile_New->setIcon(icon10);
        actFile_Open = new QAction(MainWindow);
        actFile_Open->setObjectName("actFile_Open");
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icons/images/122.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/icons/images/104.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/icons/images/CN.jpg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/icons/images/timg2.jpg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actLang_EN->setIcon(icon14);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName("centralWidget");
        textEdit = new QPlainTextEdit(centralWidget);
        textEdit->setObjectName("textEdit");
        textEdit->setGeometry(QRect(25, 25, 676, 326));
        QFont font1;
        ...
        menuBar->setGeometry(QRect(0, 0, 745, 27));
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        actLang_EN->setStatusTip(QCoreApplication::translate("MainWindow", "\345\210\207\346\215\242\344\275\277\347\224\250\350\213\261\350\257\255\347\225\214\351\235\242", nullptr));
#endif // QT_CONFIG(statustip)
